...
yum install unzip bc binutils compat-libcap1.x86_64 compat-libstdc++-33.x86_64 gcc gcc-c++ glibc glibc-devel ksh libaio libaio-devel libgcc libstdc++ libstdc++-devel libxcb libX11 libXau libXi libXtst libXrender make net-tools nfs-utils smartmontools sysstat -y
echo "创建用户"
